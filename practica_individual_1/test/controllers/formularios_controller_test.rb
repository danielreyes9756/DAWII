...
class FormulariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create formulario" do
    assert_difference('Formulario.count') do
      post formularios_url, params: { formulario: { color: @formulario.color, genre: @formulario.genre, like: @formulario.like, name: @formulario.name, surname: @formulario.surname, user_id: @formulario.user_id } }
    end
  ...
  test "should update formulario" do
    patch formulario_url(@formulario), params: { formulario: { color: @formulario.color, genre: @formulario.genre, like: @formulario.like, name: @formulario.name, surname: @formulario.surname, user_id: @formulario.user_id } }
